...
<body>
	...
	<div class="main">
		...
		<div class="center" style="font-size: 25px; text-align: center;">
			...
			<form action="/Aerodrom/letovi/filtrirajLetove" method="get">
				<table>
					<tr>
						<td>Datum polaska:</td>
			...
			<c:if test="${primenjenFilter}">
				...
				<a href="/Aerodrom/letovi/prikazLetova">Resetuj filtere</a> <br>
			</c:if>
				...
				<table border="1">
					...
					<c:forEach items="${letovi}" var="l">
						<tr>
							...
							<td>${l.cena}e</td>
							<td>
								<a href="/Aerodrom/letovi/getLetInfo?idLet=${l.idLet}">Detalji</a>
							</td>
							<td>
								<a href="/Aerodrom/letovi/rezervacija?idLet=${l.idLet}">Rezervisi</a>
							</td>
						</tr>
					</c:forEach>
				</table>
