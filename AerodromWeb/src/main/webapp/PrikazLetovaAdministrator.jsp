...
<body>
	...
	<div class="main">
		...
		<div class="center" style="font-size: 25px; text-align: center;">
			...
			<c:if test="${izbrisanLet}">
				<div class="success">
				  	<span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
				  	Let je uspesno izbrisan.
				</div>
			</c:if>
			...
			<c:if test="${izbrisanaRezervacija}">
				<div class="success">
				  	<span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
				  	Rezervacija je uspesno izbrisan.
				</div>
			</c:if>
			<form action="/Aerodrom/admin/filtrirajLetoveAdministrator" method="get">
				<table>
					<tr>
						<td>Datum polaska:</td>
			...
			<c:if test="${primenjenFilter}">
				...
				<a href="/Aerodrom/admin/prikazLetovaAdministrator">Resetuj filtere</a> <br>
			</c:if>
				...
				<table border="1">
					...
					<c:forEach items="${letovi}" var="l">
						<tr>
							...
							<td>${l.cena}e</td>
							<td>
								<a href="/Aerodrom/admin/getLetInfoAdministrator?idLet=${l.idLet}">Detalji</a>
							</td>
							<td>
								<a href="/Aerodrom/admin/izbrisiLet?idLet=${l.idLet}">Potvrdi</a>
							</td>
						</tr>
					</c:forEach>
				</table>
